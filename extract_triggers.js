//copied and modified from  https://growthrunner.com/blog/export-all-tags-from-gtm-csv/
...
document.querySelectorAll('tr[gtm-table-row]').forEach(n => {
    ...
    const firingTriggers = Array.from(n.querySelectorAll('td:nth-child(4) .gtmPredicateDirective .gtmPredicateItem .gtm-predicate-summary-row')).map(conditionElement => conditionElement.textContent.trim());
